...
Buildit::Sequence.create(:sequence_code => 'PURCHASE_REQUEST_NBR', :padding => 3, :value => 1)
...
Buildit::Sequence.create(:sequence_code => 'SKU_NBR', :padding => 3, :value => 100000)
Buildit::Sequence.create(:sequence_code => 'STYLE_NBR', :padding => 3, :value => 10000)
