  ...
  def change
    ...
    @connection = ActiveRecord::Base.connection
      ...
      create_table(:payments, :id => false) do |t|
        ...
        t.column   :payment_nbr,                     :string,            null: true,   limit: 200
        ...
        t.column   :payment_date,                    :datetime,          null: true
        ...
        t.column   :account_holder,                  :string,            null: true,    limit: 200
        t.column   :account_number,                  :string,            null: true,    limit: 200
        t.column   :expiration_date,                 :datetime,          null: true
        t.column   :ccv_code,                        :string,            null: true,    limit: 200
