  ...
  def change
    ...
    @connection = ActiveRecord::Base.connection
      ...
      create_table(:rules, :id => false) do |t|
        ...
        t.column   :rule_type,                       :string,            :null  =>  true,    :limit   => 100
        t.column   :input_attribute,                 :string,            :null  =>  true,    :limit   => 100
        t.column   :model_name,                      :string,            :null  =>  true,    :limit   => 100
        t.column   :attribute_name,                  :string,            :null  =>  true,    :limit   => 100
        t.column   :rule_action,                     :string,            :null  =>  true,    :limit   => 100
        t.column   :is_active,                       :boolean,           :null  =>  true
        t.column   :rule_seq,                        :string,            :null  =>  true,    :limit   => 6
