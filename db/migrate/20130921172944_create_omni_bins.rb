  ...
  def change
    ...
    @connection = ActiveRecord::Base.connection
      ...
      create_table(:bins, :id => false) do |t|
        ...
        t.column   :aisle,                           :string,            :null  =>  true,    :limit   => 100
        t.column   :section,                         :string,            :null  =>  true,    :limit   => 100
        t.column   :level,                           :string,            :null  =>  true,    :limit   => 100
        t.column   :position,                        :string,            :null  =>  true,    :limit   => 100
        t.column   :bin_nbr,                         :string,            :null  =>  true,    :limit   => 11
        ...
        t.column   :pick_zone,                       :string,            :null  =>  true,    :limit   => 100
        ...
        t.column   :bin_label_type,                  :string,            :null  =>  true,    :limit   => 100
