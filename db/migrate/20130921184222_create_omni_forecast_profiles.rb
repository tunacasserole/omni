  ...
  def change
    ...
    drop_table :forecast_profiles if ActiveRecord::Base.connection.tables.include?('forecast_profiles') if ActiveRecord::Base.connection.tables.include?('forecast_profiles')
      create_table(:forecast_profiles, :id => false) do |t|
        ...
        t.column   :forecast_formula,                :string,            null: true,    limit: 200
        ...
        # t.column   :contract_year_1_weight,          :string,            null: true,    limit: 200
        # t.column   :contract_year_2_weight,          :string,            null: true,    limit: 200
        # t.column   :contract_year_3_weight,          :string,            null: true,    limit: 200
        # t.column   :contract_year_4_weight,          :string,            null: true,    limit: 200
        # t.column   :contract_year_5_weight,          :string,            null: true,    limit: 200
