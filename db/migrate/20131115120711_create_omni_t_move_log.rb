  ...
  def change
    ...
    @connection = ActiveRecord::Base.connection
      ...
      create_table(:t_move_log, :id => false) do |t|
        ...
        t.column   :message_type_id,                 :string,            :null  =>  true,    :limit   => 20
        t.column   :message_type_code,               :string,            :null  =>  true,    :limit   => 20
        ...
        t.column   :location_short_name,             :string,            :null  =>  true,    :limit   => 20
