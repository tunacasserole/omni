  ...
  def change
    ...
    @connection = ActiveRecord::Base.connection
      ...
      create_table(:t_wuser, :id => false) do |t|
        ...
        t.column   :name_first,                      :string,            null: true,    limit: 200
        t.column   :name_last,                       :string,            null: true,    limit: 200
        ...
        t.column   :user_guid,                       :string,            null: true,    limit: 200
        t.column   :temp_id_flag,                    :string,            null: true
        t.column   :display_name,                    :string,            null: true,    limit: 200
      end
    # end
    # ActiveRecord::Base.establish_connection(Buildit::Util::Data::Connection.for('BUILDIT'))
  end
