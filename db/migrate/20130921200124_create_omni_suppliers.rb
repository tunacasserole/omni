  ...
  def change
    ...
    @connection = ActiveRecord::Base.connection
      ...
      create_table(:suppliers, :id => false) do |t|
        ...
        t.column   :supplier_name,                   :string,            null: true,   limit: 200
        t.column   :supplier_nbr,                    :string,            null: true,    limit: 200
        ...
        t.column   :legacy_supplier_code,            :string,            null: true,    :limit   => 200
        ...
        t.column   :supplier_url,                    :string,            null: true,    limit: 200
        t.column   :default_ship_thru_supplier_id,   :string,            null: true,    limit: 32
        t.column   :shipping_point,                  :string,            null: true,    limit: 200
        ...
        t.column   :default_payment_term,            :string,            null: true,    limit: 200
        t.column   :bank_name,                       :string,            null: true,    limit: 200
        t.column   :bank_account_name,               :string,            null: true,    limit: 200
        t.column   :bank_account_type,               :string,            null: true,    limit: 200
