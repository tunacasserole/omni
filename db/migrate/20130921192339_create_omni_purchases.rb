class CreateOmniPurchases < ActiveRecord::Migration
  def change
    ...
    t.column   :purchase_nbr,                    :string,            null: true,    limit: 200
    ...
    t.column   :payment_term,                    :string,            null: true,    limit: 200
    ...
    t.column   :supplier_address_1,              :string,            null: true,    limit: 200
    t.column   :supplier_address_2,              :string,            null: true,    limit: 200
    t.column   :supplier_address_3,              :string,            null: true,    limit: 200
    t.column   :supplier_address_4,              :string,            null: true,    limit: 200
    t.column   :supplier_city,                   :string,            null: true,    limit: 200
    t.column   :supplier_state_code,             :string,            null: true,    limit: 200
    t.column   :supplier_zip,                    :string,            null: true,    limit: 200
    t.column   :supplier_country,                :string,            null: true,    limit: 200
    ...
    t.column   :audit_created_by,                :string,            null: true,    limit: 200
    t.column   :audit_updated_by,                :string,            null: true,    limit: 200
