  ...
  def change
    ...
    @connection = ActiveRecord::Base.connection
      ...
      create_table(:container_details, :id => false) do |t|
        ...
        t.column   :container_inventory_source,      :string,            null: true,    limit: 200
        t.column   :container_detail_source,         :string,            null: true,    limit: 200
        ...
        t.column   :lot_identifier,                  :string,            null: true,    limit: 200
