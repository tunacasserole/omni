class CreateDeskTasks < ActiveRecord::Migration
  def change
    ...
    create_table(:tasks, id: false) do |t|
      ...
      t.column  :taskable_id,                   :string,        :null => false,         :limit => 32
      t.column  :taskable_type,                 :string,        :null => false,         :limit => 32
      t.column  :checklist_id,                  :string,        :null => true,          :limit => 32
      t.column  :task_nbr,                      :string,        :null => false,         :limit => 200
