class CreateDeskProjects < ActiveRecord::Migration
  def change
    ...
    create_table(:projects, :id => false) do |t|
      ...
      t.column   :project_nbr,                     :string,            :null  =>  false,   :limit   => 200
      ...
      t.column   :estimated_days,                  :decimal,     :null => true,      :default => 0,     :scale => 2,    :precision => 2
      t.column   :actual_days,                     :decimal,     :null => true,      :default => 0,     :scale => 2,    :precision => 2
    end
