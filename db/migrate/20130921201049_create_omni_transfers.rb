  ...
  def change
    ...
    @connection = ActiveRecord::Base.connection
      ...
      create_table(:transfers, :id => false) do |t|
        ...
        t.column   :transfer_nbr,                    :string,            null: true,    limit: 200
        t.column   :requesting_location_id,          :string,            null: true,   limit: 32
        ...
        t.column   :transfer_reason_id,              :string,            null: true,   limit: 32
