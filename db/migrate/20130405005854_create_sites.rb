  ...
  def change
    unless ActiveRecord::Base.connection.tables.include? 'sites'
      create_table(:sites, :id => true) do |t|
        ...
        t.column :site_type,                         :string,        :limit       => 100,    :null        => true
