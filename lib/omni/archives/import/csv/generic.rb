class Omni::Import::ExcelCsv::Generic < Omni::Import::Base

  def self.import(import)
    i = 1
    parent_hash = {'company_id' => 'Company', 'category_id' => 'Category', 'department_id' => 'Department', 'region_id' => 'Region','product_id' => 'Product','subclass_id' => 'Subclass', 'buyer_user_id' => 'User', 'product_type_id' => 'ProductType','supplier_id' => 'Supplier','add_on_sku_id'=>'Sku','site_id' => 'Site','style_id' => 'Style','color_id'=> 'Color','size_id'=>'Size','generic_style_id'=>'Style','size_group_id'=>'SizeGroup'}    
