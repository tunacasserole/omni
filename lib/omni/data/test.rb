class Omni::Data::Test
  ...
  def hierarchy
    ...
    puts "styles missing subclass count is #{count.first[0]}" if count.first[0] > 0
    ...
    puts "subclasses with invalid class count is #{count.first[0]}" if count.first[0] > 0
    ...
    puts "classes with invalid department count is #{count.first[0]}" if count.first[0] > 0
    ...
    puts "sku with invalid style count is #{count.first[0]}" if count.first[0] > 0
    ...
    puts "sku with invalid subclass count is #{count.first[0]}" if count.first[0] > 0
    ...
    puts "sku with invalid classification count is #{count.first[0]}" if count.first[0] > 0
    ...
    puts "sku with invalid department count is #{count.first[0]}" if count.first[0] > 0
  end
  ...
  def projection
    ...
    puts "projection details with missing or invalid projection count is #{count.first[0]}" if count.first[0] > 0
    ...
    puts "projection details with missing or invalid inventory count is #{count.first[0]}" if count.first[0] > 0
  end
