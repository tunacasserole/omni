...
describe "projection_detail" do
  let(:me) { create(Omni::ProjectionDetail) }
  ...
  describe "defaults" do
    it "projection_detail_id" do me.projection_detail_id.should_not be_nil end
  ...
  describe "has_many" do
    # it "notes" do c = create(Buildit::Note, notable_type: 'Omni::ProjectionDetail',notable_id: me.projection_detail_id); me.notes.count.should eq(1) end
  end
