Ext.define('Omni.view.style_color_sizes.ExplorerContextMenu', {
  ...
  clickActivate: function(btn, e, eOpts){
    Omni.logic.style_color_sizes.ExplorerProcessSelectedItems.click(btn, 'activate');
  },

  clickDeactivate: function(btn, e, eOpts){
    Omni.logic.style_color_sizes.ExplorerProcessSelectedItems.click(btn, 'deactivate');
  },
