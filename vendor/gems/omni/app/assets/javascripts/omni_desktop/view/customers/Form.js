Ext.define('Omni.view.customers.Form', {
  ...
  initComponent:function () {
    ...
    Ext.applyIf(this, {
      ...
      is_analystLabel:                            Omni.i18n.model.Customer.is_analyst,
      is_developerLabel:                          Omni.i18n.model.Customer.is_developer,
      ...
      items: [
        {
          ...
          items:[
            ...
            { name: 'tax_exempt_state',               fieldLabel: this.tax_exempt_stateLabel,           allowBlank: true,   disabled: false,    xtype: 'textfield'        },
