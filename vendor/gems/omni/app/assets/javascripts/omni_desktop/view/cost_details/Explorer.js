Ext.define('Omni.view.cost_details.Explorer', {
  ...
  contextMenuConfig: {
    xtype: 'omni-cost_details-ExplorerContextMenu'
  },
  ...
  initComponent:function () {
    ...
    Ext.apply(this, {
      columns: [
        ...
        { header: this.cost_detail_nameLabel,              dataIndex: 'cost_detail_name',            flex: 1 },    
        { header: this.cost_sourceLabel,                   dataIndex: 'cost_source',                 flex: 1 },    
