Ext.define('Omni.view.transfers.ExplorerContextMenuCancel', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-transfers-ExplorerContextMenuCancel',
  ...
  clickCancel: function(btn, e, eOpts){
    Omni.logic.transfers.ExplorerProcessSelectedItems.click(btn, 'cancel');
  },
