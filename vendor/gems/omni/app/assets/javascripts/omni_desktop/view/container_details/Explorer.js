Ext.define('Omni.view.container_details.Explorer', {
  ...
  initComponent:function () {
    ...
    Ext.applyIf(this, {
      ...
      work_order_displayLabel:               Omni.i18n.model.ContainerDetail.work_order_display,
      receipt_detail_displayLabel:           Omni.i18n.model.ContainerDetail.receipt_detail_display,
      pick_ticket_displayLabel:              Omni.i18n.model.ContainerDetail.pick_ticket_display,
    ...
    Ext.apply(this, {
      columns: [
        ...
        { header: this.pick_ticket_displayLabel,                         dataIndex: 'pick_ticket_display',                flex: 1,   sortable: true  },
