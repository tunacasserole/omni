  ...
  initComponent:function () {
    ...
    Ext.apply(this, {
      columns: [
        ...
        { header: this.tax_authority_typeLabel, dataIndex: 'tax_authority_type',  flex: 1,  sortable: true  },
        ...
        { header: this.filing_frequencyLabel, dataIndex: 'filing_frequency',  flex: 1,  sortable: true  }
      ]
    });
    // COLUMNS (End)
