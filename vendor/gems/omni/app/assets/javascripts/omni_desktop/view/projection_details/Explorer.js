Ext.define('Omni.view.projection_details.Explorer', {
  ...
  // TITLES (Start) ======================================================================
  title:     'ProjectionDetails',
  subtitle:  'Create and maintain ProjectionDetails',
  // TITLES (End)
  ...
  initComponent : function () {
    ...
    Ext.apply(this, {
      columns      : [
        {
          header       : this.projection_detail_idLabel,
          dataIndex    : 'projection_detail_id',
          flex         : 1
        },
        {
        ...
        {
          header       : this.projection_location_idLabel,
          dataIndex    : 'projection_location_id',
          flex         : 1
        },
        {
          header       : this.projection_line_nbrLabel,
          dataIndex    : 'projection_line_nbr',
          flex         : 1
        },
        {
        ...
        {
          header       : this.number_of_schoolsLabel,
          dataIndex    : 'number_of_schools',
          flex         : 1
        },
        {
