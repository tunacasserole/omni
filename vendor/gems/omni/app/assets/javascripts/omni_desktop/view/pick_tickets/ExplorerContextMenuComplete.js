Ext.define('Omni.view.pick_tickets.ExplorerContextMenuComplete', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-pick_tickets-ExplorerContextMenuComplete',
  ...
  clickComplete: function(btn, e, eOpts){
    Omni.logic.pick_tickets.ExplorerProcessSelectedItems.click(btn, 'complete');
  },
