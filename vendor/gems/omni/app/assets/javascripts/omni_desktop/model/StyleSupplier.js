Ext.define('Omni.model.StyleSupplier', {
  ...
  idProperty: 'style_supplier_id',

  proxy: {
    type: 'direct',
    api: {
      create:   Omni.service.StyleSupplier.create,
      read:     Omni.service.StyleSupplier.read,
      update:   Omni.service.StyleSupplier.update,
      destroy:  Omni.service.StyleSupplier.destroy
    },
    reader: {
      type : 'json',
      root : 'records',
