Ext.define('Omni.model.ProjectionDetail', {
  ...
  fields: [
      ...
      { name: 'first_forecast_units',        type: 'integer'  },
      { name: 'last_forecast_units',         type: 'integer'  },
      { name: 'last_forecast_date',          type: 'datetime' },
      { name: 'projection_1_units',          type: 'integer'  },
      { name: 'projection_2_units',          type: 'integer'  },
      { name: 'projection_3_units',          type: 'integer'  },
      { name: 'projection_4_units',          type: 'integer'  },
