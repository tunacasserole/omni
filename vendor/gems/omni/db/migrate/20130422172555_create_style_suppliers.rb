class CreateStyleSuppliers < ActiveRecord::Migration
  def change
    unless ActiveRecord::Base.connection.tables.include? 'style_suppliers'
      ...
      add_index(:style_suppliers, [:style_supplier_id], :unique => true)
