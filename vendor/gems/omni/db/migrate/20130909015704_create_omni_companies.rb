  ...
  def change
    ...
    @connection = ActiveRecord::Base.connection
      ...
      create_table(:companies, :id => false) do |t|
        ...
        t.column   :company_nbr,                     :string,            :null  =>  true,    :limit   => 6
        t.column   :description,                     :string,            :null  =>  true,    :limit   => 300
        t.column   :short_name,                      :string,            :null  =>  true,    :limit   => 15
        t.column   :company_url,                     :string,            :null  =>  true,    :limit   => 100
        t.column   :line_1,                          :string,            :null  =>  false,   :limit   => 100
        ...
        t.column   :city,                            :string,            :null  =>  false,   :limit   => 100
        t.column   :state_code,                      :string,            :null  =>  true,    :limit   => 2
        t.column   :zip,                             :string,            :null  =>  false,   :limit   => 10
        ...
        t.column   :phone,                           :string,            :null  =>  false,   :limit   => 30
