Ext.define('Omni.view.payments.ExplorerContextMenuApprove', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-payments-ExplorerContextMenuApprove',
  ...
  clickApprove: function(btn, e, eOpts){
    Omni.logic.payments.ExplorerProcessSelectedItems.click(btn, 'approve');
  },
