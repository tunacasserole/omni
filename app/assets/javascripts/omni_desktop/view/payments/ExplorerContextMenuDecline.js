Ext.define('Omni.view.payments.ExplorerContextMenuDecline', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-payments-ExplorerContextMenuDecline',
  ...
  initComponent: function() {
    ...
    Ext.apply(this, {
      ...
      rightActions: [
        ...
        /**
         * Decline
         * Supports performing 'Decline' on the selected items in the explorer grid.
  ...
  clickDecline: function(btn, e, eOpts){
    Omni.logic.payments.ExplorerProcessSelectedItems.click(btn, 'decline');
  },
