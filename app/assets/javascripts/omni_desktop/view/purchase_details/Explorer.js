  ...
  initComponent:function () {
    ...
    Ext.apply(this, {
      columns: [
        ...
        { header: this.supplier_costLabel,                 dataIndex: 'supplier_cost',               flex: 1 },    
        { header: this.order_cost_unitsLabel,              dataIndex: 'order_cost_units',            flex: 1 },    
        ...
        { header: this.units_orderedLabel,                 dataIndex: 'units_ordered',               flex: 1 },    
        { header: this.order_pack_sizeLabel,               dataIndex: 'order_pack_size',             flex: 1 },    
