Ext.define('Omni.view.container_details.Form', {
  ...
  initComponent:function () {
    ...
    Ext.applyIf(this, {
      ...
      work_order_idLabel:                         Omni.i18n.model.ContainerDetail.work_order_id,
      receipt_detail_idLabel:                     Omni.i18n.model.ContainerDetail.receipt_detail_id,
      pick_ticket_idLabel:                        Omni.i18n.model.ContainerDetail.pick_ticket_id,
    ...
    Ext.apply(this, {
      items: [
        ...
        },
        {
          ...
          layout: 'anchor',
          items:[
            { name: 'pick_ticket_id',                 fieldLabel: this.pick_ticket_idLabel,             allowBlank: true,   disabled: false,    xtype: 'buildit-Locator',     store:      Ext.create('Omni.store.PickTicket',{pageSize: 10}), displayField: 'display', queryField: 'display', valueField: 'pick_ticket_id', itemTpl:'{display}' },
