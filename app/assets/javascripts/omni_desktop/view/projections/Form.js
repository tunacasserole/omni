      ...
      items: [
        {
          ...
          items:[
            ...
            { name: 'projection_approver_id', fieldLabel: this.projection_approver_idLabel, allowBlank: true, xtype: 'buildit-Locator',     store:      Ext.create('Buildit.store.User',{pageSize: 10}), displayField: 'full_name', queryField: 'full_name', valueField: 'user_id', itemTpl:'{full_name}' },
            { name: 'projection_closer_id', fieldLabel: this.projection_closer_idLabel, allowBlank: true,  xtype: 'buildit-Locator',     store:      Ext.create('Buildit.store.User',{pageSize: 10}), displayField: 'full_name', queryField: 'full_name', valueField: 'user_id', itemTpl:'{full_name}' },
