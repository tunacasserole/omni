Ext.define('Omni.view.pick_tickets.ExplorerContextMenuShip', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-pick_tickets-ExplorerContextMenuShip',
  ...
  clickShip: function(btn, e, eOpts){
    Omni.logic.pick_tickets.ExplorerProcessSelectedItems.click(btn, 'ship');
  },
