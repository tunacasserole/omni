      ...
      items: [
        {
          ...
          */
            ...
            { xtype: 'textfield', name: 'site_name',                      fieldLabel: this.site_nameLabel                   , allowBlank: display },    
            ...
            { xtype: 'textfield', name: 'site_type',                      fieldLabel: this.site_typeLabel                   , allowBlank: true },    
            { xtype: 'textfield', name: 'location_id',                    fieldLabel: this.location_idLabel                 , allowBlank: true },    
            { xtype: 'textfield', name: 'is_on_web',                      fieldLabel: this.is_on_webLabel                   , allowBlank: true },    
            { xtype: 'textfield', name: 'gradeset',                       fieldLabel: this.gradesetLabel                    , allowBlank: true },    
            { xtype: 'textfield', name: 'site_gender',                    fieldLabel: this.site_genderLabel                 , allowBlank: true },    
            ...
            { xtype: 'textfield', name: 'state_code',                     fieldLabel: this.state_codeLabel                  , allowBlank: true },    
