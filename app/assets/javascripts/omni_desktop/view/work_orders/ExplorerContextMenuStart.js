Ext.define('Omni.view.work_orders.ExplorerContextMenuStart', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-work_orders-ExplorerContextMenuStart',
  ...
  clickStart: function(btn, e, eOpts){
    Omni.logic.work_orders.ExplorerProcessSelectedItems.click(btn, 'start');
  },
