Ext.define('Omni.view.work_orders.ExplorerContextMenuCancel', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-work_orders-ExplorerContextMenuCancel',
  ...
  clickCancel: function(btn, e, eOpts){
    Omni.logic.work_orders.ExplorerProcessSelectedItems.click(btn, 'cancel');
  },
