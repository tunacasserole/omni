      ...
      items: [
        ...
        },
        {
          ...
          items:[
            ...
            { name: 'subclass_id',                    fieldLabel: this.subclass_idLabel,                allowBlank: false,   disabled: false,    xtype: 'buildit-Locator',     store:      Ext.create('Omni.store.Subclass',{pageSize: 25}), displayField: 'display', queryField: 'display', valueField: 'subclass_id', itemTpl:'{display}' },
