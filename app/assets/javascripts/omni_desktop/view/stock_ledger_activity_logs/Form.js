      ...
      items: [
        {
          ...
          items:[
            ...
            { name: 'activity_log_nbr',               fieldLabel: this.activity_log_nbrLabel,           allowBlank: true,  disabled: false,    xtype: 'textfield'        },
            { name: 'model_name',                     fieldLabel: this.model_meta_idLabel,              allowBlank: true,  disabled: false,    xtype: 'textfield'        },
            { name: 'attribute_name',                 fieldLabel: this.attribute_meta_idLabel,          allowBlank: true,  disabled: false,    xtype: 'textfield'        },
