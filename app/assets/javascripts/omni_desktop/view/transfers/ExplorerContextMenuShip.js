Ext.define('Omni.view.transfers.ExplorerContextMenuShip', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-transfers-ExplorerContextMenuShip',
  ...
  clickShip: function(btn, e, eOpts){
    Omni.logic.transfers.ExplorerProcessSelectedItems.click(btn, 'ship');
  },
