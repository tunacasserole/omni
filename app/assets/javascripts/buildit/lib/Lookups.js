...
Ext.create('Ext.data.ArrayStore', {
  ...
  fields    : lookupStoreFields,
  data      : [
    ['8038CE1AAOEUIDH495B122000A9D0283','VOUCHER',,'TENDER_TYPE','Voucher',null,true],
...
Ext.create('Ext.data.ArrayStore', {
  ...
  fields    : lookupStoreFields,
  data      : [
    ['EBAE1106972811E295B122000A9D0283','PICK_TICKET',,'ORDER_FULFILLMENT_METHOD','Pick',null,true],
...
Ext.create('Ext.data.ArrayStore', {
  ...
  data      : [
    ...
    ['151EEB46972911E2A3D212313B10044E','SHIPPING',,'PHONE_TYPE','Shipping',null,true],
