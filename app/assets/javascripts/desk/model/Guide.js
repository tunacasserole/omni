Ext.define('Desk.model.Guide', {
    ...
    fields: [ {name: 'guide_id',type: 'string'},
{name: 'owner_id',type: 'string'},
{name: 'guide_nbr',type: 'string'},
{name: 'guide_name',type: 'string'},
{name: 'description',type: 'string'},
{name: 'guide_location',type: 'string'},
{name: 'gem_name',type: 'string'},
{name: 'owner_display',type: 'string'},
