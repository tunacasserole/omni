Ext.define('Omni.model.Customer', {
  ...
  fields:[
    ...
    { name: 'phone_type_1',                         type: 'string'      },
    { name: 'phone_2',                              type: 'string'      },
    { name: 'phone_type_2',                         type: 'string'      },
    { name: 'phone_3',                              type: 'string'      },
    { name: 'phone_type_3',                         type: 'string'      },
    // { name: 'fax_1',                                type: 'string'      },
    // { name: 'fax_2',                                type: 'string'      },
