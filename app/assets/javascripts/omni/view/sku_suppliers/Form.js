    ...
    Ext.apply(this, {
      ...
      items: [{
        ...
        items: [{
          ...
          name: 'is_primary',
          fieldLabel: this.is_primaryLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'checkbox'
        }, {
          name: 'is_manufacturer',
          fieldLabel: this.is_manufacturerLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'checkbox'
        }, {
        ...
        items: [{
          ...
          name: 'supplier_cost_units',
          fieldLabel: this.supplier_cost_unitsLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          ...
          name: 'is_included_extra_cost',
          fieldLabel: this.is_included_extra_costLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'checkbox'
        }, {
        ...
        layout: 'anchor',
        items: [{
          name: 'master_pack_units',
          fieldLabel: this.master_pack_unitsLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          name: 'master_pack_uom_code',
          fieldLabel: this.master_pack_uom_codeLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'buildit-Lookup',
          category: 'MASTER_PACK_UOM_CODE'
        }, {
          name: 'master_pack_length',
          fieldLabel: this.master_pack_lengthLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          name: 'master_pack_height',
          fieldLabel: this.master_pack_heightLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          name: 'master_pack_width',
          fieldLabel: this.master_pack_widthLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          name: 'master_pack_weight',
          fieldLabel: this.master_pack_weightLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }]
        ...
        layout: 'anchor',
        items: [{
          name: 'inner_pack_units',
          fieldLabel: this.inner_pack_unitsLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          name: 'inner_pack_uom_code',
          fieldLabel: this.inner_pack_uom_codeLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'buildit-Lookup',
          category: 'INNER_PACK_UOM_CODE'
        }, {
          name: 'inner_pack_length',
          fieldLabel: this.inner_pack_lengthLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          name: 'inner_pack_height',
          fieldLabel: this.inner_pack_heightLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          name: 'inner_pack_width',
          fieldLabel: this.inner_pack_widthLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          name: 'inner_pack_weight',
          fieldLabel: this.inner_pack_weightLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }]
        ...
        items: [{
          ...
          name: 'minimum_order_units',
          fieldLabel: this.minimum_order_unitsLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          name: 'minimum_order_value',
          fieldLabel: this.minimum_order_valueLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          name: 'minimum_order_weight',
          fieldLabel: this.minimum_order_weightLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          name: 'minimum_order_cube',
          fieldLabel: this.minimum_order_cubeLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          ...
          name: 'origin_country',
          fieldLabel: this.origin_countryLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
        ...
        layout: 'anchor',
        items: [{
            name: 'is_conveyable_master_pack',
            fieldLabel: this.is_conveyable_master_packLabel,
            allowBlank: true,
            disabled: false,
            xtype: 'checkbox'
          }, {
            name: 'is_conveyable_inner_pack',
            fieldLabel: this.is_conveyable_inner_packLabel,
            allowBlank: true,
            disabled: false,
            xtype: 'checkbox'
          }, {
            name: 'pallet_tie',
            fieldLabel: this.pallet_tieLabel,
            allowBlank: true,
            disabled: false,
            xtype: 'textfield'
          }, {
            name: 'pallet_high',
            fieldLabel: this.pallet_highLabel,
            allowBlank: true,
            disabled: false,
            xtype: 'textfield'
          },
