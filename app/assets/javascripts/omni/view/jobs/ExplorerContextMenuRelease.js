Ext.define('Omni.view.jobs.ExplorerContextMenuRelease', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-jobs-ExplorerContextMenuRelease',
  ...
  clickRelease: function(btn, e, eOpts){
    Omni.logic.jobs.ExplorerProcessSelectedItems.click(btn, 'release');
  },
