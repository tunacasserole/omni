Ext.define('Omni.view.jobs.ExplorerContextMenuComplete', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-jobs-ExplorerContextMenuComplete',
  ...
  clickComplete: function(btn, e, eOpts){
    Omni.logic.jobs.ExplorerProcessSelectedItems.click(btn, 'complete');
  },
