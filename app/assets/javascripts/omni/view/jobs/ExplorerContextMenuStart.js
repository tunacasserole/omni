Ext.define('Omni.view.jobs.ExplorerContextMenuStart', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-jobs-ExplorerContextMenuStart',
  ...
  clickStart: function(btn, e, eOpts){
    Omni.logic.jobs.ExplorerProcessSelectedItems.click(btn, 'start');
  },
