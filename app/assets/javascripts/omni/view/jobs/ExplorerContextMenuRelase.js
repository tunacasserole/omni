Ext.define('Omni.view.jobs.ExplorerContextMenuRelase', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-jobs-ExplorerContextMenuRelase',
  ...
  clickRelase: function(btn, e, eOpts){
    Omni.logic.jobs.ExplorerProcessSelectedItems.click(btn, 'relase');
  },
