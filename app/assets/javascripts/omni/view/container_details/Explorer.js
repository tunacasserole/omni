  ...
  initComponent: function() {
    ...
    Ext.apply(this, {
      columns: [{
        ...
        header: this.supplier_item_identifierLabel,
        dataIndex: 'supplier_item_identifier',
        flex: 1,
        sortable: false
      }, {
        ...
        header: this.receipt_detail_displayLabel,
        dataIndex: 'receipt_detail_display',
        flex: 1,
        sortable: false
      }, {
        header: this.pick_displayLabel,
        dataIndex: 'pick_display',
        flex: 1,
        sortable: false
      }, {
        header: this.origin_container_detail_displayLabel,
        dataIndex: 'origin_container_detail_display',
        flex: 1,
        sortable: false
      }, {
