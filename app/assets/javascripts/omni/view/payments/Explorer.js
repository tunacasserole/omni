Ext.define('Omni.view.payments.Explorer', {
  ...
  stateLabelLabel: Omni.i18n.model.Payment.stateLabel,
  payment_amountLabelLabel: Omni.i18n.model.Payment.payment_amountLabel,
  ...
  initComponent: function() {
    ...
    Ext.apply(this, {
      columns: [{
        header: this.order_displayLabel,
        dataIndex: 'order_display',
        flex: 1,
        sortable: false
      }, {
        header: this.customer_displayLabel,
        ...
        header: this.payment_amountLabel,
