  ...
  initComponent: function() {
    ...
    Ext.apply(this, {
      items: [{
        ...
        items: [{
          name: 'ruleset_id',
          fieldLabel: this.ruleset_idLabel,
          allowBlank: false,
          disabled: false,
          ...
          queryField: 'display',
          valueField: 'ruleset_id',
          initialValue    : this.record.get('ruleset_display'),
          itemTpl: '{display}'
        }, {
          name: 'rule_type',
          fieldLabel: this.rule_typeLabel,
          allowBlank: true,
          disabled: false,
          ...
          fieldLabel: this.input_attributeLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          name: 'model_name',
          fieldLabel: this.model_nameLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }, {
          ...
          name: 'rule_action',
          fieldLabel: this.rule_actionLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'buildit-Lookup',
          ...
          name: 'is_active',
          fieldLabel: this.is_activeLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'checkbox'
        }, {
          name: 'rule_seq',
          fieldLabel: this.rule_seqLabel,
          allowBlank: true,
          disabled: false,
          xtype: 'textfield'
        }]
    ...
    Ext.applyIf(this, {
      ...
      subtitle: 'Edit Rules',
      newTitle: 'New Rules',
      newSubtitle: 'Complete the following to create a new rule'
    });
    // TITLES (End)
    this.callParent();
  }
