Ext.define('Omni.view.transfers.ExplorerContextMenuApprove', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-transfers-ExplorerContextMenuApprove',
  ...
  clickApprove: function(btn, e, eOpts){
    Omni.logic.transfers.ExplorerProcessSelectedItems.click(btn, 'approve');
  },
