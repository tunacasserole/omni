Ext.define('Omni.view.picks.ExplorerContextMenuComplete', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-picks-ExplorerContextMenuComplete',
  ...
  clickComplete: function(btn, e, eOpts){
    Omni.logic.picks.ExplorerProcessSelectedItems.click(btn, 'complete');
  },
