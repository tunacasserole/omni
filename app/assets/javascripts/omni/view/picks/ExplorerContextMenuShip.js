Ext.define('Omni.view.picks.ExplorerContextMenuShip', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-picks-ExplorerContextMenuShip',
  ...
  clickShip: function(btn, e, eOpts){
    Omni.logic.picks.ExplorerProcessSelectedItems.click(btn, 'ship');
  },
