Ext.define('Omni.view.picks.ExplorerContextMenuRelease', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-picks-ExplorerContextMenuRelease',
  ...
  clickRelease: function(btn, e, eOpts){
    Omni.logic.picks.ExplorerProcessSelectedItems.click(btn, 'release');
  },
