Ext.define('Omni.view.picks.ExplorerContextMenuStart', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-picks-ExplorerContextMenuStart',
  ...
  clickStart: function(btn, e, eOpts){
    Omni.logic.picks.ExplorerProcessSelectedItems.click(btn, 'start');
  },
