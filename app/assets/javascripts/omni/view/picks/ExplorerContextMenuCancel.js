Ext.define('Omni.view.picks.ExplorerContextMenuCancel', {
  extend: 'Buildit.ux.ContextMenu',
  alias:  'widget.omni-picks-ExplorerContextMenuCancel',
  ...
  clickCancel: function(btn, e, eOpts){
    Omni.logic.picks.ExplorerProcessSelectedItems.click(btn, 'cancel');
  },
