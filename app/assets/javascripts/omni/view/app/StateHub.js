  ...
  initComponent: function(){
    ...
    // Section: All States //
     ...
     tiles: [
       ...
       {title: 'Release Pick Ticket', colspan: 2, rowspan: 1, cls: 'release_picks purple',  target: {xtype: 'omni-picks-Explorer', title: 'Release Pick Ticket', defaultSearch: { with: {state: {equal_to: 'new'}} }, contextMenuConfig: {xtype: 'omni-picks-ExplorerContextMenuRelease'}, store: Ext.create('Omni.store.Pick',{storeId: 'ReleasePickStore'}), allowNew: true}},
       {title: 'Start  Pick Ticket', colspan: 2, rowspan: 1, cls: 'start_picks purple1',  target: {xtype: 'omni-picks-Explorer', title: 'Start  Pick Ticket', defaultSearch: { with: {state: {equal_to: 'pending'}} }, contextMenuConfig: {xtype: 'omni-picks-ExplorerContextMenuStart'}, store: Ext.create('Omni.store.Pick',{storeId: 'StartPickStore'}), allowNew: true}},
       {title: 'Complete Pick Ticket', colspan: 2, rowspan: 1, cls: 'complete_picks purple2',  target: {xtype: 'omni-picks-Explorer', title: 'Complete Pick Ticket', defaultSearch: { with: {state: {equal_to: 'open'}} }, contextMenuConfig: {xtype: 'omni-picks-ExplorerContextMenuComplete'}, store: Ext.create('Omni.store.Pick',{storeId: 'CompletePickStore'}), allowNew: true}},
       {title: 'Ship Pick Ticket', colspan: 2, rowspan: 1, cls: 'ship_picks purple3',  target: {xtype: 'omni-picks-Explorer', title: 'Ship Pick Ticket', defaultSearch: { with: {state: {equal_to: 'complete'}} }, contextMenuConfig: {xtype: 'omni-picks-ExplorerContextMenuShip'}, store: Ext.create('Omni.store.Pick',{storeId: 'ShipPickStore'}), allowNew: true}},
       {title: 'Cancel Pick Ticket', colspan: 2, rowspan: 1, cls: 'cancel_picks purple4',  target: {xtype: 'omni-picks-Explorer', title: 'Cancel Pick Ticket', defaultSearch: { with: {state: {any_of: ['new','pending']}} }, contextMenuConfig: {xtype: 'omni-picks-ExplorerContextMenuCancel'}, store: Ext.create('Omni.store.Pick',{storeId: 'CancelPickStore'}), allowNew: true}},
