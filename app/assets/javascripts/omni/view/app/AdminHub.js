...
Ext.define('Omni.view.app.AdminHub', {
	extend: 'Buildit.ux.Hub',
	alias: 'widget.omni-app-AdminHub',
  ...
  //
   ...
   title: 'Customer Order Entry',
     ...
     tiles: [
       ...
       {title: 'Cancel Jobs', colspan: 2, rowspan: 1, cls: 'cancel_jobs magenta',  target: {xtype: 'omni-jobs-Explorer', title: 'Cancel Job', defaultSearch: { with: {state: {any_of: ['new','pending']}} }, contextMenuConfig: {xtype: 'omni-jobs-ExplorerContextMenuCancel'}, store: Ext.create('Omni.store.Job',{storeId: 'CancelJobStore'}), allowNew: false}},
