...
Ext.define('Omni.view.app.WarehouseHub', {
  ...
  initComponent: function(){
    ...
    // Section: Order Fulfillment //
     ...
     rows: 4,
     tiles: [
       {title: 'Release Picks', colspan: 4, rowspan: 1, cls: 'release_picks purple1', badge: '3',  target: {xtype: 'omni-picks-Explorer', title: 'Release Picks', defaultSearch: { with: {state: {equal_to: 'new'}} }, contextMenuConfig: {xtype: 'omni-picks-ExplorerContextMenuRelease'}, store: Ext.create('Omni.store.Pick',{storeId: 'ReleasePickStore'}), allowNew: false}},
       {title: 'Fulfill Picks', colspan: 4, rowspan: 1, cls: 'start_picks purple3', badge: '3',  target: {xtype: 'omni-picks-Explorer', title: 'Fulfill Picks', defaultSearch: { with: {state: {equal_to: 'pending'}} }, contextMenuConfig: {xtype: 'omni-picks-ExplorerContextMenuStart'}, store: Ext.create('Omni.store.Pick',{storeId: 'StartPickStore'}), allowNew: false}},
    ...
    // Section: Demand Processing //
     ...
     rows: 3,
     tiles: [
       {title: 'Picks', colspan: 2, rowspan: 1, cls: '_picks purple1',  target: {xtype: 'omni-picks-Explorer', title: 'Picks'}},
       {title: 'Release Picks', colspan: 2, rowspan: 1, cls: 'release_picks purple3',  target: {xtype: 'omni-picks-Explorer', title: 'Release Picks', defaultSearch: { with: {state: {equal_to: 'new'}} }, contextMenuConfig: {xtype: 'omni-picks-ExplorerContextMenuRelease'}, store: Ext.create('Omni.store.Pick',{storeId: 'ReleasePickStore'}), allowNew: false}},
       {title: 'Start Picks', colspan: 2, rowspan: 1, cls: 'start_picks pink2',  target: {xtype: 'omni-picks-Explorer', title: 'Start Picks', defaultSearch: { with: {state: {equal_to: 'pending'}} }, contextMenuConfig: {xtype: 'omni-picks-ExplorerContextMenuStart'}, store: Ext.create('Omni.store.Pick',{storeId: 'StartPickStore'}), allowNew: false}},
       {title: 'Complete Picks', colspan: 2, rowspan: 1, cls: 'complete_picks purple2',  target: {xtype: 'omni-picks-Explorer', title: 'Complete Picks', defaultSearch: { with: {state: {equal_to: 'open'}} }, contextMenuConfig: {xtype: 'omni-picks-ExplorerContextMenuComplete'}, store: Ext.create('Omni.store.Pick',{storeId: 'CompletePickStore'}), allowNew: false}},
       {title: 'Ship Picks', colspan: 2, rowspan: 1, cls: 'ship_picks purple2',  target: {xtype: 'omni-picks-Explorer', title: 'Ship Picks', defaultSearch: { with: {state: {equal_to: 'complete'}} }, contextMenuConfig: {xtype: 'omni-picks-ExplorerContextMenuShip'}, store: Ext.create('Omni.store.Pick',{storeId: 'ShipPickStore'}), allowNew: false}},
       {title: 'Cancel Picks', colspan: 2, rowspan: 1, cls: 'cancel_picks purple1',  target: {xtype: 'omni-picks-Explorer', title: 'Cancel Picks', defaultSearch: { with: {state: {any_of: ['new','pending']}} }, contextMenuConfig: {xtype: 'omni-picks-ExplorerContextMenuCancel'}, store: Ext.create('Omni.store.Pick',{storeId: 'CancelPickStore'}), allowNew: false}},
