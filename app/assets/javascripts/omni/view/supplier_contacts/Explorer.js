Ext.define('Omni.view.supplier_contacts.Explorer', {
  ...
  initComponent:function () {
    ...
    Ext.apply(this, {
      ...
      contextMenuConfig:{
        xtype:'omni-supplier_contacts-ExplorerContextMenu',
      },
    ...
    Ext.apply(this, {
      columns: [
        ...
        { header: this.is_order_contactLabel, dataIndex: 'is_order_contact',  flex: 1,  sortable: false  },
        { header: this.is_return_contactLabel, dataIndex: 'is_return_contact',  flex: 1,  sortable: false  },
        { header: this.is_payment_contactLabel, dataIndex: 'is_payment_contact',  flex: 1,  sortable: false  },
        { header: this.is_executive_contactLabel, dataIndex: 'is_executive_contact',  flex: 1,  sortable: false  },
      ]
    });
    // COLUMNS (End)
