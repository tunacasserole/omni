...
class Omni::Test::Base
  ...
  def self.create_base_test_data
    ...
    Omni::Style.create(style_id: 'D4EB81EE0EC711E3BFA320C9D047DD15', display: '0010PKGRL-BU-391-BU391b1', concatenated_name: '*BLOUSE, SS, P-PAN', pos_name: '*BLOUSE, SS, P-PAN', size_group_id: '636F7E9EAC5711E299E700FF58D32228', style_nbr: '54504', description: '*BLOUSE, SS, P-PAN', subclass_id: 'B1D7091EAC5511E299E700FF58D32228', product_id: '3DC7C7B8FE1F11E28D2320C9D047DD15', product_type_id: 'B25227F6AC5611E299E700FF58D32228', fabric_content: '65% POLY 35% COTTON', initial_retail_price: 15.50, site_id: '0E5E192EAC5211E299E700FF58D32228', state: 'active', is_converted: true, conversion_type: 'MONOGRAM') unless Omni::Style.where(style_id: 'D4EB81EE0EC711E3BFA320C9D047DD15').first
    Omni::Sku.create(:sku_id => '285C928C0F3611E3BB7120C9D047DD15',:display =>'0010PKGRL-BU-391-BU391b1-WHT-GL',:sku_nbr=>'75886',:source=>'BUCKHEAD',:source_id=>'344',:design_code=>'BU391b1',:state=>'active',:site_id=>'0036FF32AC5211E299E700FF58D32228',:style_id=>'D4EB81EE0EC711E3BFA320C9D047DD15',:color_id=>'0B7965A0AC5811E299E700FF58D32228',:size_id=>'41352886FE0711E280D020C9D047DD15',:initial_retail_price => 15.50) unless Omni::Sku.where(:sku_id => '285C928C0F3611E3BB7120C9D047DD15').first

    Omni::Supplier.where(:supplier_id => 'B931D2A4AC5311E299E700FFSUPPLIER').to_a.each {|x| x.delete}
    Omni::Supplier.where(:supplier_name => "Olivander's Wands").to_a.each {|x| x.delete}
    Omni::Supplier.create(:supplier_id => 'B931D2A4AC5311E299E700FFSUPPLIER', :supplier_name=>"Olivander's Wands", :line_1=>'123 Maple St', :line_2=>'Ste 300', :line_3=>'Attn: Sam', :city=>'Sandy Springs', :state_code=>'GA', :zip=>'30303', :country=>'USA', :phone => '999-999-9999', :default_ship_thru_supplier_id=>'B931D2A4AC5311E299E700FFSUPPLIER', :default_pay_to_supplier_id=>'B931D2A4AC5311E299E700FFSUPPLIER', :shipping_point=>'Hong Kong', :ship_via=>'Ocean', :freight_term=>'PREPAID', :lead_time=>60, :default_payment_term=>'NET', :is_enabled=>true)

    Omni::SkuSupplier.where(:sku_supplier_id => '239F5610231F11E3BE4920C9D047DD15').to_a.each {|x| x.delete}
    Omni::SkuSupplier.create(:sku_supplier_id => '239F5610231F11E3BE4920C9D047DD15', :sku_id => '285C928C0F3611E3BB7120C9D047DD15',:supplier_id => 'B931D2A4AC5311E299E700FFSUPPLIER', :supplier_cost=>100, :supplier_cost_units=>1, :supplier_item_identifier=>'The Elder Wand', :master_pack_units=>1, :master_pack_uom_code=>'EACH', :inner_pack_units=>1, :inner_pack_uom_code=>'EACH', :extra_cost=>10, :is_included_extra_cost=>true, :origin_country=>'China', :freight_term=>'PREPAID', :pack_type=>'SELL_UNIT') unless Omni::SkuSupplier.where(:sku_supplier_id => '239F5610231F11E3BE4920C9D047DD15').first

    Omni::Inventory.where(sku_id: '285C928C0F3611E3BB7120C9D047DD15').to_a.each {|x| x.delete}
    Omni::Inventory.create(inventory_id: 'INVENTORYFORSKU1LOCATION1XXXXXXX', sku_id: '285C928C0F3611E3BB7120C9D047DD15', location_id: '51713A3EAC3E11E2947800FF58D32228', department_id: '05A9CEBAAC5511E299E700FF58D32228', supplier_id: 'B931D2A4AC5311E299E700FFSUPPLIER', forecast_profile_id: 'XXXXXXXXXXXXXXXXFORECASTPROFILE1', on_hand_units: 10, work_in_process_units: 20, supplier_on_order_units: 30, sale_units_py1: 100, sale_units_py2: 200, sale_units_py3: 300, sale_units_ytd: 50, is_authorized: true)
    Omni::Inventory.create(inventory_id: 'INVENTORYFORSKU1LOCATION2XXXXXXX', sku_id: '285C928C0F3611E3BB7120C9D047DD15', location_id: '51892F68AC3E11E2947800FF58D32228', department_id: '05A9CEBAAC5511E299E700FF58D32228', supplier_id: 'B931D2A4AC5311E299E700FFSUPPLIER', forecast_profile_id: 'XXXXXXXXXXXXXXXXFORECASTPROFILE1', on_hand_units: 10, work_in_process_units: 20, supplier_on_order_units: 30, sale_units_py1: 100, sale_units_py2: 200, sale_units_py3: 300, sale_units_ytd: 50, is_authorized: true)
    Omni::Inventory.create(inventory_id: 'INVENTORYFORSKU1LOCATION4XXXXXXX', sku_id: '285C928C0F3611E3BB7120C9D047DD15', location_id: '5247A038AC3E11E2947800FF58D32228', department_id: '05A9CEBAAC5511E299E700FF58D32228', supplier_id: 'B931D2A4AC5311E299E700FFSUPPLIER', forecast_profile_id: 'XXXXXXXXXXXXXXXXFORECASTPROFILE1', on_hand_units: 10, work_in_process_units: 20, supplier_on_order_units: 30, sale_units_py1: 100, sale_units_py2: 200, sale_units_py3: 300, sale_units_ytd: 50, is_authorized: true)
  ...
  def self.allocation_scenarios
    x = []
    x << {scenario: 'Supply equals Demand',:allocation_profile_id => 'XXXXLASTFORECASTBYPERCENTTOSTORE', :units_to_allocate => 100, :order_pack_size => 1, :percent_to_allocate=>100, :allocated_units_locked_loc_1=>0,  :allocated_units_locked_loc_2=>0,  :allocated_units_locked_loc_3=>0, :expected_allocation_results_loc_1=>50, :expected_allocation_results_loc_2=>40, :expected_allocation_results_loc_3=>10 }
    x << {scenario: 'Excess Supply',             :allocation_profile_id => 'XXXXLASTFORECASTBYPERCENTTOSTORE', :units_to_allocate => 1000, :order_pack_size => 10, :percent_to_allocate=>100, :allocated_units_locked_loc_1=>0,  :allocated_units_locked_loc_2=>0,  :allocated_units_locked_loc_3=>0, :expected_allocation_results_loc_1=>500, :expected_allocation_results_loc_2=>400, :expected_allocation_results_loc_3=>100,}
    x << {scenario: 'Excess Demand',           :allocation_profile_id => 'XXXXLASTFORECASTBYPERCENTTOSTORE', :units_to_allocate => 100, :order_pack_size => 1, :percent_to_allocate=>1, :allocated_units_locked_loc_1=>0,  :allocated_units_locked_loc_2=>0,  :allocated_units_locked_loc_3=>0, :expected_allocation_results_loc_1=>1, :expected_allocation_results_loc_2=>0, :expected_allocation_results_loc_3=>0}
    x << {scenario: 'Excess Demand',           :allocation_profile_id => 'XXXXLASTFORECASTBYPERCENTTOSTORE', :units_to_allocate => 1000, :order_pack_size => 10, :percent_to_allocate=>1, :allocated_units_locked_loc_1=>0,  :allocated_units_locked_loc_2=>0,  :allocated_units_locked_loc_3=>0, :expected_allocation_results_loc_1=>5, :expected_allocation_results_loc_2=>4, :expected_allocation_results_loc_3=>1}
    ...
    x << {scenario: 'Excess Supply',              :allocation_profile_id => 'XXXXLASTFORECASTBYPERCENTTOSTORE', :units_to_allocate => 1000, :order_pack_size => 10, :percent_to_allocate=>80, :allocated_units_locked_loc_1=>0,  :allocated_units_locked_loc_2=>0,  :allocated_units_locked_loc_3=>0, :expected_allocation_results_loc_1=>400, :expected_allocation_results_loc_2=>320, :expected_allocation_results_loc_3=>80}
