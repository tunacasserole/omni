class Omni::Test::Projection < Omni::Test::Base
  ...
  def self.process_projection_scenario(s)
    ...
    case s[:compare_to]
    when 'projection'
      actual_result = x.send(s[:actual_result])
    when 'projection_detail'
      actual_result = y.send(s[:actual_result])
    when 'email'
      actual_result = 'not yet implemented'
    end
  ...
  def self.closing_scenarios
    ...
    x=[]
    x << {:scenario_description=>'It prevents Closing from new state', :user_id=>user_2, projection_state: 'new', projection_approver_user_id: nil, projection_closer_id: nil, approval_3_date: nil, approval_4_date: nil, projection_detail_state: 'approved', projection_1_units: 100, projection_2_units: 0, projection_3_units: 0, projection_4_units: 0,                                                              expected_result: 'new',        compare_to: 'projection', actual_result: 'state'}
    x << {:scenario_description=>'It prevents Closing from new state', :user_id=>user_2, projection_state: 'new', projection_approver_user_id: nil, projection_closer_id: nil, approval_3_date: nil, approval_4_date: nil, projection_detail_state: 'approved', projection_1_units: 100, projection_2_units: 0, projection_3_units: 0, projection_4_units: 0,                                                              expected_result: 'draft',       compare_to: 'projection', actual_result: 'state'}
    x << {:scenario_description=>'It prevents Closing from new state', :user_id=>user_2, projection_state: 'new', projection_approver_user_id: nil, projection_closer_id: nil, approval_3_date: nil, approval_4_date: nil, projection_detail_state: 'approved', projection_1_units: 100, projection_2_units: 0, projection_3_units: 0, projection_4_units: 0,                                                              expected_result: 'forecast',  compare_to: 'projection', actual_result: 'state'}
    x << {:scenario_description=>'It prevents Closing from new state', :user_id=>user_2, projection_state: 'new', projection_approver_user_id: user_2, projection_closer_id: user_2, approval_3_date: Date.yesterday, approval_4_date: Date.yesterday, projection_detail_state: 'approved', projection_1_units: 100, projection_2_units: 150, projection_3_units: 200, projection_4_units: 250,expected_result: 'complete',compare_to: 'projection', actual_result: 'state'}
    ...
    x << {:scenario_description=>'It updates state from projection_1 to projection_2', :user_id=>user_2, projection_state: 'projection_1', projection_approver_user_id: nil, projection_closer_id: nil, approval_3_date: nil, approval_4_date: nil, projection_detail_state: 'approved',  projection_1_units: 100, projection_2_units: 0, projection_3_units: 0, projection_4_units: 0,expected_result: 'projection_2', compare_to: 'projection', actual_result: 'state'}
    x << {:scenario_description=>'It updates projection_closer_user_id', :user_id=>user_2, projection_state: 'projection_1', projection_approver_user_id: nil, projection_closer_id: nil, approval_3_date: nil, approval_4_date: nil, projection_detail_state: 'approved',  projection_1_units: 100, projection_2_units: 0, projection_3_units: 0, projection_4_units: 0,                     expected_result: user_2,            compare_to: 'projection', actual_result: 'projection_closer_user_id'}
    x << {:scenario_description=>'It updates Projection Detail projection_2_units', :user_id=>user_2, projection_state: 'projection_1', projection_approver_user_id: nil, projection_closer_id: nil, approval_3_date: nil, approval_4_date: nil, projection_detail_state: 'approved',  projection_1_units: 100, projection_2_units: 0, projection_3_units: 0, projection_4_units: 0,     expected_result: 150,                compare_to: 'projection_detail', actual_result: 'projection_2_units'}
    x << {:scenario_description=>'It updates Projection Detail state', :user_id=>user_2, projection_state: 'projection_1', projection_approver_user_id: nil, projection_closer_id: nil, approval_3_date: nil, approval_4_date: nil, projection_detail_state: 'approved',  projection_1_units: 100, projection_2_units: 0, projection_3_units: 0, projection_4_units: 0,     expected_result: 'approved',      compare_to: 'projection_detail', actual_result: 'state'}
    x << {:scenario_description=>'It updates Projection Detail state', :user_id=>user_2, projection_state: 'projection_1', projection_approver_user_id: nil, projection_closer_id: nil, approval_3_date: nil, approval_4_date: nil, projection_detail_state: 'approved',  projection_1_units: 100, projection_2_units: 0, projection_3_units: 0, projection_4_units: 0,     expected_result: 'approved',      compare_to: 'projection_detail', actual_result: 'state'}

    x << {:scenario_description=>'It prevents Closing without proper Permission', :user_id=>user_1, projection_state: 'projection_2', projection_approver_user_id: nil, projection_closer_id: user_1, approval_3_date: nil, approval_4_date: nil, projection_detail_state: 'approved',  projection_1_units: 100, projection_2_units: 150, projection_3_units: 0, projection_4_units: 0,     expected_result: 'projection_2',      compare_to: 'projection', actual_result: 'state'}
    x << {:scenario_description=>'It updates state from projection_2 to projection_3', :user_id=>user_2, projection_state: 'projection_2', projection_approver_user_id: nil, projection_closer_id: user_1, approval_3_date: nil, approval_4_date: nil, projection_detail_state: 'approved',  projection_1_units: 100, projection_2_units: 150, projection_3_units: 0, projection_4_units: 0,     expected_result: 'projection_3',      compare_to: 'projection', actual_result: 'state'}
    x << {:scenario_description=>'It updates projection_closer_user_id', :user_id=>user_2, projection_state: 'projection_2', projection_approver_user_id: nil, projection_closer_id: user_1, approval_3_date: nil, approval_4_date: nil, projection_detail_state: 'approved',  projection_1_units: 100, projection_2_units: 150, projection_3_units: 0, projection_4_units: 0,     expected_result: 'user_2',      compare_to: 'projection', actual_result: 'state'}
    x << {:scenario_description=>'It updates Projection Detail projection_3_units', :user_id=>user_2, projection_state: 'projection_2', projection_approver_user_id: nil, projection_closer_id: user_1, approval_3_date: nil, approval_4_date: nil, projection_detail_state: 'approved',  projection_1_units: 100, projection_2_units: 150, projection_3_units: 0, projection_4_units: 0,     expected_result: 200,      compare_to: 'projection_detail', actual_result: 'state'}
    x << {:scenario_description=>'It updates Projection Detail state', :user_id=>user_2, projection_state: 'projection_2', projection_approver_user_id: nil, projection_closer_id: user_1, approval_3_date: nil, approval_4_date: nil, projection_detail_state: 'draft',  projection_1_units: 100, projection_2_units: 150, projection_3_units: 0, projection_4_units: 0,     expected_result: 'approved',      compare_to: 'projection_detail', actual_result: 'state'}
    x << {:scenario_description=>'It sends an email to Projection Approver', :user_id=>user_2, projection_state: 'projection_2', projection_approver_user_id: nil, projection_closer_id: user_1, approval_3_date: nil, approval_4_date: nil, projection_detail_state: 'draft',  projection_1_units: 100, projection_2_units: 150, projection_3_units: 0, projection_4_units: 0,     expected_result: user_1,      compare_to: 'email', actual_result: 'recipient'}

    x << {:scenario_description=>'It prevents Closing without proper Permission', :user_id=>user_1, projection_state: 'projection_3', projection_approver_user_id: nil, projection_closer_id: user_1, approval_3_date: Date.yesterday, approval_4_date: nil, projection_detail_state: 'approved',  projection_1_units: 100, projection_2_units: 150, projection_3_units: 200, projection_4_units: 0,     expected_result: 'projection_2',      compare_to: 'projection', actual_result: 'state'}
    x << {:scenario_description=>'It updates state from projection_3 to projection_4', :user_id=>user_2, projection_state: 'projection_3', projection_approver_user_id: nil, projection_closer_id: user_1, approval_3_date: Date.yesterday, approval_4_date: nil, projection_detail_state: 'approved',  projection_1_units: 100, projection_2_units: 150, projection_3_units: 200, projection_4_units: 0,     expected_result: 'projection_3',      compare_to: 'projection', actual_result: 'state'}
    x << {:scenario_description=>'It updates projection_closer_user_id', :user_id=>user_2, projection_state: 'projection_3', projection_approver_user_id: nil, projection_closer_id: user_1, approval_3_date: Date.yesterday, approval_4_date: nil, projection_detail_state: 'approved',  projection_1_units: 100, projection_2_units: 150, projection_3_units: 200, projection_4_units: 0,     expected_result: 'user_2',      compare_to: 'projection', actual_result: 'state'}
    x << {:scenario_description=>'It updates Projection Detail projection_4_units', :user_id=>user_2, projection_state: 'projection_3', projection_approver_user_id: nil, projection_closer_id: user_1, approval_3_date: Date.yesterday, approval_4_date: nil, projection_detail_state: 'approved',  projection_1_units: 100, projection_2_units: 150, projection_3_units: 200, projection_4_units: 0,     expected_result: 200,      compare_to: 'projection', actual_result: 'state'}
    x << {:scenario_description=>'It updates Projection Detail state', :user_id=>user_2, projection_state: 'projection_3', projection_approver_user_id: nil, projection_closer_id: user_1, approval_3_date: Date.yesterday, approval_4_date: nil, projection_detail_state: 'draft',  projection_1_units: 100, projection_2_units: 150, projection_3_units: 200, projection_4_units: 0,     expected_result: 'approved',      compare_to: 'projection', actual_result: 'state'}
    x << {:scenario_description=>'It sends an email to Projection Approver', :user_id=>user_2, projection_state: 'projection_3', projection_approver_user_id: user_1, projection_closer_id: user_1, approval_3_date: Date.yesterday, approval_4_date: nil, projection_detail_state: 'draft',  projection_1_units: 100, projection_2_units: 150, projection_3_units: 200, projection_4_units: 0,     expected_result: user_1,      compare_to: 'email', actual_result: 'recipient'}
    x
  end
  ...
  def self.create_security_data
    Buildit::User.where(user_id: ['TESTUSERXXXXXXXXXXXXXXXBUYERBILL','TESTUSERXXXXXXXXXXXXXPLANNERPAUL','TESTUSERXXXXXXXXMERCHANDISERMARY','TESTUSERXXXXXXXXXXXBIGCHEESEBART','TESTUSERXXXXXXXXXXXXXXBUYERBETTY']).each {|x| x.delete}
    Buildit::User.create(user_id: 'TESTUSERXXXXXXXXXXXXXXXBUYERBILL',email_address: 'thenderson@parkersu.com', first_name: 'Bill', last_name: 'Buyer and Planner' )
    Buildit::User.create(user_id: 'TESTUSERXXXXXXXXXXXXXPLANNERPAUL',email_address: 'thenderson@parkersu.com', first_name: 'Paul', last_name: 'Planning Director' )
    Buildit::User.create(user_id: 'TESTUSERXXXXXXXXMERCHANDISERMARY',email_address: 'thenderson@parkersu.com', first_name: 'Mary', last_name: 'Merchandise Director' )
    Buildit::User.create(user_id: 'TESTUSERXXXXXXXXXXXBIGCHEESEBART',email_address: 'thenderson@parkersu.com', first_name: 'Bart', last_name: 'Big Cheese' )
    Buildit::User.create(user_id: 'TESTUSERXXXXXXXXXXXXXXBUYERBETTY',email_address: 'thenderson@parkersu.com', first_name: 'Betty', last_name: 'Buyer and Planner' )

    Buildit::Role.where(role_id: ['TESTROLEMERCHANDISEDIRECTORXXXXX','TESTROLEBUYERXXXXXXXXXXXXXXXXXXX','TESTROLECEOXXXXXXXXXXXXXXXXXXXXX','TESTROLEPLANNERXXXXXXXXXXXXXXXXX','TESTROLEPLANNINGDIRECTORXXXXXXXX']).all.each {|x| x.delete}
    ...
    Buildit::Privilege.where(privilege_code: ['PURCHASE_APPROVER_1', 'PURCHASE_APPROVER_2','PURCHASE_APPROVER_3','PROJECTION_CLOSER','PROJECTION_APPROVER']).all.each {|x|x.delete}
