class Omni::SkuPriceRequest < ActiveRecord::Base
  ...
  def after_price
    ...
    self.price_book_id = self.site.location.price_book.price_book_id if self.site and self.site.location and self.site.location.price_book
    self.price_book_id = self.location.price_book.price_book_id if !self.site_id and self.location and self.location.price_book      
    # Get Permanent Price
